...
import { ArrowLeft, Home, Calendar, Car, Users, Banknote, X, Pen, Trash2, Link as LinkIcon, Image as ImageIcon, Upload, Globe } from "lucide-react";
...
export default function WeddingHallsVendorModal({ isOpen, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    // Step 6 - Service Coverage (UPDATED)
    selectedEvents: [],
    timeSlots: [],
    serviceOffers: "",
    venuePhotos: [],
